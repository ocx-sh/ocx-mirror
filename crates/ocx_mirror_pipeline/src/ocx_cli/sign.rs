...
use ocx_mirror_spec::{KeyConfig, KeylessConfig, Ref, SignConfig};
...
pub fn resolve_sign_from_env(config: Option<&SignConfig>) -> Result<Option<ResolvedSign>, MirrorError> {
    config
