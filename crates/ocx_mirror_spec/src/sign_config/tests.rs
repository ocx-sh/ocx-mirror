...
//! [`load_spec`](crate::load_spec), because the exit code C-050/C-051
...
use super::*;
use crate::{MirrorSpec, load_spec, validate_sign_config};
...
fn a_tag_on_sign_does_not_hide_a_raw_shape() {
    for (yaml, needle) in [
        ...
        let error = crate::validate::refuse_raw_sign_shapes(&value, std::path::Path::new("mirror.yml"))
