<!-- generated by grim from ghcr.io/ocx-sh/lore/docs-quality@sha256:c31e99d6d45536c089f643dd96d3fe23540fbbd918530bd68497ab029f2d12bf; edits will be overwritten -->
> Applies only when working on files matching `README.md`, `CHANGELOG.md`, `CONTRIBUTING.md`, `docs/**`, `doc/**`, `website/**`, `site/**`, `mkdocs.yml`, `book.toml`, `.vitepress/config.*`, `docusaurus.config.*`.
