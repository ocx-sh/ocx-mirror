...
- [ ] All existing tests pass without modification (`task rust:verify` for Rust changes)
...
**Gate**: `task rust:verify` pass. No test mods needed. Diff clean + focused.
...
| Cross-module refactor | Use `/swarm-plan` — wider review breadth applies |
